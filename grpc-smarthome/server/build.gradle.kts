...
tasks.register<JavaExec>("SmartHomeServer") {
    dependsOn("classes")
    classpath = sourceSets["main"].runtimeClasspath
    mainClass.set("io.grpc.examples.smarthome.SmartHomeServerKt")
}

tasks.register<JavaExec>("SmartFridgeServer") {
    dependsOn("classes")
    classpath = sourceSets["main"].runtimeClasspath
    mainClass.set("io.grpc.examples.smarthome.SmartFridgeServerKt")
}
...
val smartHomeServerStartScripts = tasks.register<CreateStartScripts>("smartHomeServerStartScripts") {
    mainClass.set("io.grpc.examples.smarthome.SmartHomeServerKt")
...
val smartFridgeServerStartScripts = tasks.register<CreateStartScripts>("smartFridgeServerStartScripts") {
    mainClass.set("io.grpc.examples.smarthome.SmartFridgeServerKt")
...
tasks.named("startScripts") {
    ...
    dependsOn(smartHomeServerStartScripts)
    dependsOn(smartFridgeServerStartScripts)
}
